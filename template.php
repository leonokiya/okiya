	...
	<div class="container agile-banner_nav">
		<div class="row header-top">
			<div class="col-md-5 top-left p-0">
				<p><i class="fa fa-phone" aria-hidden="true"></i> +254 790 119 982 </p>
			</div>
			<div class="col-md-7 top-right p-0">
				<p><i class="fa fa-map-marker" aria-hidden="true"></i> OARS, the Online Artifact Management System for you.
			</div>
		</div>
	
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			
			<h1><a class="navbar-brand" href="<?= base_url() ?>">Digi-Museum</a></h1>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="dropdown nav-item <?php if($this->uri->segment(1) == "Tour" || $this->uri->segment(1) == "Tourguide") echo 'active' ?>">
						...
						<ul class="dropdown-menu agile_short_dropdown">
							<li>
								<a href="<?= base_url().'index.php/Tour/showall' ?>">Exhibitions</a>
							</li>
							<li>
	...
	<div class="container py-md-3">
		<div class="row footer-grids pb-md-5 pb-3">	
			<div class="col-md-3 col-sm-6 col-6">
				<a href="tel: 0790119982> <i class="fa fa-phone"></i>Call Us</a>
			</div>
			<div class="col-md-3 col-sm-6 col-6">
				<a href="mailto: info@skamanguya.com"> <i class="fa fa-envelope"></i>Send Message</a>
			</div>
...
<section class="copyright py-4 text-center">
	<div class="container">
		<p>Copyright &copy; OARS 2023.| Developed by <a href="http://leonokiya97.com/" target="=_blank"> L. Okiya </a></p>
	</div>
</section>
<!-- //copyright -->
